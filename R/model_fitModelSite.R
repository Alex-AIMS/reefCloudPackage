...
#' @description Fits model to data at site level
#' @examples model_fitModelSite()
#' @export
model_fitModelSite <- function(){
    ...
    reefCloudPackage::ReefCloud_tryCatch({
      ## ---- reefCloudPackage::simpleINLA.sites
      {
        ...
        reefCloudPackage::log('INFO', logFile = LOG_FILE,
                      ...
                      msg = paste0(DOMAIN_NAME, ": ", stringr::str_to_title(nSITE),"/", nDEPTH, "m depth/",nREEF_ZONE," zone Simple INLA cellmeans calculated"))
        ## ---- simpleINLAData.site
